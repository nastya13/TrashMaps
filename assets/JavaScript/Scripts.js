...
function autoRoute() {
    if (!isAutoRouted) {
        ...
        if (autoRoutCase == 1) {
            ...
            // Ново-Савиновский (truck 1)
            ymaps.route([
                    [55.823146, 49.14788],
                    [55.850176, 49.090756], // 1
                    [55.811948, 49.077848], // 1
                    [55.839375, 49.063079], // 1
                    [55.814093, 49.103333] // 1
                ]
                ).then(function (route) {
                    curAutoRoute = route;
                    myMap.geoObjects.add(route);
...
//    addTruck([55.828207, 49.133893]); // Ново-савиновский (2)
